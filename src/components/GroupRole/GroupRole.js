...
const GroupRole = (props) => {
  ...
  // build data to save
  const builddDataToSave = () => {
    const _asignRolesByGroup = _.cloneDeep(asignRolesByGroup);
    let result = {};
    result.groupId = +selectGroup;

    // build data
    let groupRolesFilter = _asignRolesByGroup.filter((item) => {
